...
app_description = "Generate barcodes for Items with active serial nos."
...
doctype_js = {"Delivery Note" : "public/js/custom_barcode_scanner.js", 
...
override_doctype_class = {
	"QR Scanner": "barcode_generator.qr.custom.qr_scanner.CustomQRScanner"
}
